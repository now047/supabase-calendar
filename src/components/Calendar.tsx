...
import {
  ...
  EventContentArg, EventHoveringArg
} from "@fullcalendar/core";
import jaLocale from '@fullcalendar/core/locales/ja';
import dayjs from "dayjs";

import { supabase } from "../lib/api";
import IEvent, { dateToTimestamp, toDateString, strToTimestamp, toLocalDateString } from "../lib/event-utils";
import { colorMap, getResourceId, getResourceName } from "../lib/resource-utils";
...
const Calendar = (props: {
  ...
  const action = (
    <React.Fragment>
      <Button color="secondary" size="small" onClick={handleMouseLeave.bind(null, null)}>
        got it
      </Button>
    </React.Fragment>
  );
